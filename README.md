...
+ **name yourself**. Onload Bogbook will ask you to identify your keypair with a nickname. You can change this name at any time by posting a new `type: name` post via your profile page. Once you've added a name, consider introducing yourself here: http://bogbook.com/#M1jR2wBtUO2v+3HIa4xypc3f0+Z6YvYY2wKn/hEe/QQ=
